...
./crawler http://sheinstein.com/notyetexist.php ../tse-output/argstest-depth 2
if [ $? -ne 0 ]; then
...
#good practice to set it back to default
chmod +w ../tse-output/notWriteable/
...
echo " Expect 1 file from simple html at depth 2"
...
ls l../tse-output/letters-depth-2/ | wc -l
...
echo "Section 4 Testing: Wikipedia playground at depths 0, 1, 2"
...
echo "Section 5:  Testing: Additional tests"
...
echo "Testing crawler on toscrape html file at depth 1"
echo "Expect 585 file from toscrape html at Depth 1."
